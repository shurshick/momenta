...
Текущая стабильная версия: **v0.2.21**.
...
```yaml
image: ghcr.io/shurshick/momenta:v0.2.21
```
...
Latest release: [v0.2.21](https://github.com/shurshick/momenta/releases/tag/v0.2.21)

Release artifacts:

- Docker image: `ghcr.io/shurshick/momenta:v0.2.21`
