...
Текущая стабильная версия: **v0.2.29**.
...
```yaml
image: ghcr.io/shurshick/momenta:v0.2.29
```
...
Latest release: [v0.2.29](https://github.com/shurshick/momenta/releases/tag/v0.2.29)

Release artifacts:

- Docker image: `ghcr.io/shurshick/momenta:v0.2.29`
