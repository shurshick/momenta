...
Текущая стабильная версия: **v0.2.37**.
...
Для **v0.2.37** новых миграций БД нет.

## Релизы

- Release: [v0.2.37](https://github.com/shurshick/momenta/releases/tag/v0.2.37)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.37`
