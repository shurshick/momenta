...
Текущая стабильная версия: **v0.2.46**.
...
Для **v0.2.46** новых миграций БД нет.
...
- Release: [v0.2.46](https://github.com/shurshick/momenta/releases/tag/v0.2.46)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.46`
