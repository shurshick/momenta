...
Текущая стабильная версия: **v0.2.30**.
...
```yaml
image: ghcr.io/shurshick/momenta:v0.2.30
```
...
Latest release: [v0.2.30](https://github.com/shurshick/momenta/releases/tag/v0.2.30)

Release artifacts:

- Docker image: `ghcr.io/shurshick/momenta:v0.2.30`
