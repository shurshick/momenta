...
Текущая стабильная версия: **v0.2.42**.
...
Для **v0.2.42** новых миграций БД нет.
...
- Release: [v0.2.42](https://github.com/shurshick/momenta/releases/tag/v0.2.42)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.42`
