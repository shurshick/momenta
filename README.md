...
Текущая стабильная версия: **v0.2.34**.
...
```yaml
image: ghcr.io/shurshick/momenta:v0.2.34
```

Документация по обновлению TrueNAS: [docs/DEPLOY_TRUENAS.md](docs/DEPLOY_TRUENAS.md)

Для **v0.2.34** новых миграций БД нет.

## Релизы

- Release: [v0.2.34](https://github.com/shurshick/momenta/releases/tag/v0.2.34)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.34`
