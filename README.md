...
Текущая стабильная версия: **v0.2.38**.
...
Для **v0.2.38** новых миграций БД нет.

## Релизы

- Release: [v0.2.38](https://github.com/shurshick/momenta/releases/tag/v0.2.38)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.38`
