...
Текущая стабильная версия: **v0.2.50**.
...
Для **v0.2.50** новых миграций БД нет.
...
- Release: [v0.2.50](https://github.com/shurshick/momenta/releases/tag/v0.2.50)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.50`
