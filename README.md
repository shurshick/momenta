...
Текущая стабильная версия: **v0.2.22**.
...
Latest release: [v0.2.22](https://github.com/shurshick/momenta/releases/tag/v0.2.22)

Release artifacts:

- Docker image: `ghcr.io/shurshick/momenta:v0.2.22`
