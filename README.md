...
Текущая стабильная версия: **v0.2.20**.
...
```yaml
image: ghcr.io/shurshick/momenta:v0.2.20
```
...
Latest release: [v0.2.20](https://github.com/shurshick/momenta/releases/tag/v0.2.20)

Release artifacts:

- Docker image: `ghcr.io/shurshick/momenta:v0.2.20`
