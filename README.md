...
Текущая стабильная версия: **v0.2.49**.
...
Для **v0.2.49** новых миграций БД нет.
...
- Release: [v0.2.49](https://github.com/shurshick/momenta/releases/tag/v0.2.49)
- Docker image: `ghcr.io/shurshick/momenta:v0.2.49`
